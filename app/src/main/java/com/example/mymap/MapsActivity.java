...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            Log.e(TAG, "ERROR! No es Posible Hallar el Estilo...!", e);
        }

        // Add a marker in Sydney and move the camera
        LatLng tacna = new LatLng(-18.026274, -70.269258);
        mMap.addMarker(new MarkerOptions().position(tacna).title("My Home"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(tacna, zoom));
        GroundOverlayOptions iconOverlay = new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.casa))
                .position(tacna,100);
